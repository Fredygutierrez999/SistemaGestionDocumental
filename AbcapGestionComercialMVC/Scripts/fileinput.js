...
(function (factory) {
    ...
    $.fn.fileinput.defaults = {
        ...
        browseIcon: '<i class="glyphicon glyphicon-folder-open alig-left"></i>',
        browseClass: 'btn btn-primary',
        removeIcon: '<i class="glyphicon glyphicon-trash alig-left"></i>',
        removeClass: 'btn btn-default btn-secondary',
        cancelIcon: '<i class="glyphicon glyphicon-ban-circle"></i>',
        cancelClass: 'btn btn-default btn-secondary',
        uploadIcon: '<i class="glyphicon glyphicon-upload alig-left"></i>',
